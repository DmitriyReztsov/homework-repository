...
def set_func_values(first_func):
    def another_wrapper(wrapper_func):
        wrapper_func.__doc__ = first_func.__doc__
        wrapper_func.__name__ = first_func.__name__
        wrapper_func.__original_func = first_func
        return wrapper_func
